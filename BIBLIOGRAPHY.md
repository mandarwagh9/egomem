...
_Surfaced via SOTA search 2026-06-15 (arXiv links returned by search; used to frame Cycle 11 / §9, not all individually fetched)._
- **[openeqa]** Majumdar et al. *OpenEQA: Embodied Question Answering in the Era of Foundation Models.* CVPR 2024. <https://open-eqa.github.io/> — episodic-memory embodied VQA from egocentric clips; best VLM (GPT-4V) ~49.6% vs human ~86.8% ("nearly blind"). The benchmark family Cycle 11 targets.
- **[emembench]** *EMemBench: Interactive Benchmarking of Episodic Memory for VLM Agents.* 2026. <https://arxiv.org/abs/2601.16690> — spatial reasoning a persistent VLM-memory bottleneck.
- **[findingdory]** *FindingDory: A Benchmark to Evaluate Memory in Embodied Agents.* 2025. <https://arxiv.org/abs/2506.15635>.
- **[memoryvla]** *MemoryVLA: Perceptual-Cognitive Memory in Vision-Language-Action Models for Robotic Manipulation.* 2025. <https://arxiv.org/abs/2508.19236> — SOTA memory-in-VLA (hippocampus-inspired bank); model-bound, manipulation (LIBERO/CALVIN).
